...
pub const DEFAULT_SOLVER_PARAMS: SolverParams = SolverParams {
    ...
    sub_block_size_cells: CHUNK_SIZE_I32 / 2,
    sub_block_promote_frames: 1,
    sub_block_demote_frames: 20,
    sub_block_min_active_frames: 24,
    sub_block_promote_neighbor_radius: 1,
    sub_block_debt_promote_threshold: 0.8,
    sub_block_mass_flux_promote_threshold: 62.5,
    sub_block_penetration_promote_threshold_m: CELL_SIZE_M * 0.35,
    sub_block_contact_promote_frames: 45,
    sub_block_max_level: 8,
    sub_block_level0_max_norm_disp: 0.1,
    sub_block_near_field_extra_chunks: 1,
